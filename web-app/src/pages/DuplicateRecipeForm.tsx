...
const DuplicateRecipeForm = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log("Recipe added:", created);

            // Support either _id or id in the response
            const newId = (created as any)._id ?? (created as any).id;
            if (!newId) {
                // Defensive guard in case backend shape changes
                throw new Error("Created recipe did not include an id");
            }
