...
import { addRecipe, getRecipeById } from '../api/recipeAPI';
...
const DuplicateRecipeForm = () => {
    ...
    useEffect(() => {
        const fetchRecipe = async () => {
            ...
            if (data) setRecipe({ ...data, _id: undefined, name: `${data.name} (Copy)` });
        };
        fetchRecipe();
    }, [id]);
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!newId) throw new Error('Created recipe did not include an id');
